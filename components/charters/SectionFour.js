      ...
      <div id="charters-section4" className="w-full absolute top-0 left-0 h-full">
          ...
          {contactForm ? (
            ...
            >
              <div className="flex justify-between items-center my-2">
                <label className="w-[140px] text-[#D79B2A]">Name</label>
                <input
              ...
              <div className="flex justify-start items-center my-2">
                <label className="w-[140px] text-[#D79B2A]">Company</label>
                <input
              ...
              <div className="flex justify-between items-center my-2">
                <label className="w-[140px] text-[#D79B2A]">Mob./Cell Ph.</label>
                <input
              ...
              <div className="flex justify-between items-center my-2">
                <label className="w-[140px] text-[#D79B2A]">Email ID</label>
                <input
              ...
              <div className="flex justify-between items-start my-2">
                <label className="w-[140px] text-[#D79B2A]">Message</label>
                <textarea
              ...
              <button type="submit" className="absolute bottom-4 text-[#D79B2A] left-6 uppercase">
                Sent
              </button>
            </form>
          ) : (
            ...
            >
              <div className="flex justify-between items-center my-2">
                <label className="w-[165px] text-[#D79B2A]">Name</label>
                <input
              ...
              <div className="flex justify-between items-center my-2">
                <label className="w-[165px] text-[#D79B2A]">Email ID</label>
                <input
              ...
              <div className="flex justify-between items-center my-2">
                <label className="w-[165px] text-[#D79B2A]">Phone Number</label>
                <input
                  placeholder="Phone Number"
              ...
              <div className="flex justify-between items-center my-2">
                <label className="w-[165px] text-[#D79B2A]">Departure Date</label>
                <input
                  required
              ...
              <div className="flex justify-between items-start my-2">
                <label className="w-[165px] text-[#D79B2A]">Departure</label>
                <input
              ...
              <div className="flex justify-between items-start my-2">
                <label className="w-[165px] text-[#D79B2A]">Arrival</label>
                <input
                  required
                  placeholder="Arrival"
                  className="w-full px-3 text-black rounded-tl-[20px] rounded-br-[20px] py-1"
              ...
              <div className="flex justify-between items-start my-2">
                <label className="w-[165px] text-[#D79B2A]">No. Of Luggage</label>
                <input
                  required
              ...
              <div className="flex justify-start items-start my-2 text-black">
                <label className="w-[125px] text-[#D79B2A]">Luggage Size</label>
                <select
                  name="luggage-size"
                  required
                  onChange={(e) => setBookingFormLuggageSize(e.target.value)}
                  className="rounded-tl-[20px] rounded-br-[20px] py-1 px-3 outline-none"
                >
        ...
        {contactForm ? (
          ...
          >
            ...
            <div className="flex justify-between items-center my-2">
              <label className="w-[140px] text-[#D79B2A]">Phone Number</label>
              <input
                placeholder="Phone Number"
                onChange={(e) => setBookingFormPhoneNumber(e.target.value)}
                className="w-full px-3 text-black rounded-tl-[20px] rounded-br-[20px] py-1"
            ...
            <div className="flex justify-between items-center my-2">
              <label className="w-[140px] text-[#D79B2A]">Departure Date</label>
              <input
                required
                placeholder="Choose your date"
                className="w-full px-3 text-black rounded-tl-[20px] rounded-br-[20px] py-1"
            ...
            <div className="flex justify-between items-start my-2">
              <label className="w-[140px] text-[#D79B2A]">Departure</label>
              <input
                placeholder="Departure"
                className="w-full px-3 text-black rounded-tl-[20px] rounded-br-[20px] py-1"
                type="text"
            ...
            <div className="flex justify-between items-start my-2">
              <label className="w-[140px] text-[#D79B2A]">Arrival</label>
              <input
                required
                placeholder="Arrival"
                className="w-full px-3 text-black rounded-tl-[20px] rounded-br-[20px] py-1"
            ...
            <div className="flex justify-between items-start my-2">
              <label className="w-[140px] text-[#D79B2A]">No. Of Luggage</label>
              <input
                required
                placeholder="No. Of Luggage"
                className="w-full px-3 text-black rounded-tl-[20px] rounded-br-[20px] py-1"
            ...
            <div className="flex justify-start items-start my-2 text-black">
              <label className="w-[90px] text-[#D79B2A]">Luggage Size</label>
              <select
                name="luggage-size"
                required
                onChange={(e) => setBookingFormLuggageSize(e.target.value)}
        ...
        <div className="absolute sm:w-[324px] w-[80%] rounded-[24px] h-[175px] lg:top-[350px] bottom-24 left-10 md:left-24 bg-black/90">
          <Slider className="w-full h-full flex" {...settings}>
            <div className="h-full flex-1 flex justify-center items-center w-full">
              ...
              <q className="px-6 font-fritz-regular text-[12px] font-semibold">- By</q>
            </div>
            <div className="h-full flex-1 flex justify-center items-center w-full">
              <div className="flex h-full w-full pt-7 px-6">
                <p className="text-balance font-fritz-regular flex-1 font-light text-[10px]">
