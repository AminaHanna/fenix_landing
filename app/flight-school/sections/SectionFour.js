...
// If you actually use react-slick here, import it dynamically. You don't render <Slider> in this code, so it's omitted
  ...
  return (
    <section id="section4" className="relative text-white font-fritz-regular w-full h-screen">
      ...
      <div id="fourth-section" className="w-full absolute top-0 left-0 h-full">
        ...
        <form
          onSubmit={handleEnquiry}
          className="720px:hidden block bg-[#3C3C3B] px-6 pt-3 pb-1 mx-4 rounded-tl-[20px] absolute top-32 992px:left-7 rounded-br-[20px] w-full h-fit"
        >
          <div className="flex justify-between items-center my-2">
            <label className="w-[140px] text-[#D79B2A]">Name</label>
            <input
